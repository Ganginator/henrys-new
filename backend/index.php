<?php
require_once get_template_directory().'/backend/pages/global/settings.php';
require_once get_template_directory().'/backend/functions/importer.php';
require_once get_template_directory().'/backend/functions/getbowtied-tgm/class-tgm-plugin-activation.php';
require_once get_template_directory().'/backend/functions/getbowtied-tgm/plugins.php';
...
if( ! class_exists( 'Getbowtied_Admin_Pages' ) ) {
	...
	class Getbowtied_Admin_Pages {		
		...
		{
			require_once get_template_directory().'/backend/pages/welcome_theme.php';
		}

		function getbowtied_theme_registration_page()
		{
			require_once get_template_directory().'/backend/pages/registration.php';
		}

		function getbowtied_theme_plugins_page()
		{
			require_once get_template_directory().'/backend/pages/plugins.php';
		}

		function getbowtied_theme_demos_page()
		{
			require_once get_template_directory().'/backend/pages/demos.php';
		}

		function getbowtied_theme_help_center_page()
		{
			require_once get_template_directory().'/backend/pages/help-center.php';
		}

		function getbowtied_welcome_page() 
		{
			require_once get_template_directory().'/backend/pages/welcome.php';
		}
